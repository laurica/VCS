...
void SubsequenceAnalyzer::subsequenceLength(vector<Line>& s, 
                                            vector<Line>& t,
...
void SubsequenceAnalyzer::getSubsequence(int ** grid, vector<Line>& s,
                                         vector<Line>& t,
                                         vector<Line>& subsequence) {
    int sLen = s.size();
    int tLen = t.size();
...
void SubsequenceAnalyzer::getInsertions(vector<Line>& subsequence, 
                                        vector<Line>& newString, 
                                        vector<NewLine>& insertedLines) {
...
void SubsequenceAnalyzer::getDeletions(vector<Line>& subsequence,
                                       vector<Line>& oldString,
                                       vector<DeletedLine>& deletedLines) {
...
void SubsequenceAnalyzer::outputDiff(vector<Line>& subsequence, 
                                     vector<NewLine>& insertions, 
                                     vector<DeletedLine>& deletions) {
...
void SubsequenceAnalyzer::calculateSubsequence(vector<Line>& s,
                                               vector<Line>& t,
                                               vector<Line>& subsequence) {
